...
| Check | Command | Exit | Evidence |
| --- | --- | ---: | --- |
| Full Swift test suite | `cd macos && swift test --parallel` | 0 | Build completed; XCTest enumerated `[1/114]` through `[114/114]` with no failures. Swift Testing compatibility summary printed `Test run with 0 tests in 0 suites passed`. |
