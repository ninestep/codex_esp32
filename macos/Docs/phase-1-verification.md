...
| Check | Command | Exit | Evidence |
| --- | --- | ---: | --- |
| Full Swift test suite | `cd macos && swift test --parallel` | 0 | Build completed; XCTest enumerated `[1/117]` through `[117/117]` with no failures. Swift Testing compatibility summary printed `Test run with 0 tests in 0 suites passed`. |
| Swift build | `cd macos && swift build` | 0 | `Build complete! (0.45s)`. |
